...
procedure GetMouseEvent(var mouseEvent:MouseEventType);
function GetMouseX: word;
function GetMouseY: word;
function GetMouseWheel: smallint;
function PollMouseEvent(var mouseEvent:MouseEventType): boolean;
...
function PollMouseEvent(var mouseEvent:MouseEventType): boolean;
begin
  if (nr_readmouse = nr_inputmouse) then PollMouseEvent:=false else
  begin
